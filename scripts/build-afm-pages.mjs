...
const PAGE_CSS = `<style>
  ...
  .afm-paper-body p { margin: 0 0 18px; font-size: 16.5px; line-height: 1.68; }
  .afm-paper-body a { color: #a9791f; text-decoration: underline; }
  .afm-paper-body strong { color: #163b5c; }
  .afm-ed-head { font-family: Georgia, 'Times New Roman', serif; font-weight: bold; font-size: 21px; color: #163b5c; margin: 0 0 12px; }
  .afm-ed-teaser { font-family: Georgia, 'Times New Roman', serif; font-style: italic; font-size: 14.5px; color: #6a7a8a; line-height: 1.6; border-left: 3px solid #e8b84a; padding-left: 14px; margin: 0 0 22px; }
  ...
  .afm-ed-nav { display: flex; justify-content: space-between; gap: 18px; flex-wrap: wrap; max-width: 720px; margin: 26px auto 0; font-family: 'Courier Prime', monospace; font-size: 12px; letter-spacing: 1.6px; }
...
<section style="max-width:900px;margin:0 auto;padding:56px 24px 30px">
  <div style="font-family:'Courier Prime',monospace;font-size:12.5px;letter-spacing:2.4px;color:#9a8f7d;margin-bottom:18px">EXHIBIT NO. 04 — WING A · THE AFM ARCHIVE · <a href="../newsletter.html" class="kicker-link">BACK TO THE CATALOG</a></div>
  ...
  <div style="font-family:'Courier Prime',monospace;font-size:12px;letter-spacing:2px;color:#ffcf6b">EDITION NO. ${ed.num} · FRIDAY ${ed.dateDisplay}${ed.linkedin ? ` · <a href="${ed.linkedin}" target="_blank" rel="noopener" style="color:#ffcf6b">ALSO ON LINKEDIN ↗</a>` : ""}</div>
</section>
...
<section style="border-top:1px solid rgba(243,240,232,0.14)">
  <div style="max-width:900px;margin:0 auto;padding:64px 24px 76px;text-align:center">
    ...
    <p style="font-size:15.5px;color:rgba(243,240,232,0.6);margin:0 0 28px">Every Friday morning since 2018. Free, no spam, unsubscribe anytime.</p>
